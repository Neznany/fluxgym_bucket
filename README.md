...
(I know the script says min_bucket_reso and max_bucket_reso are ignored if bucket_no_upscale is set, but actually it needsa to be set as the max bucket size is calculated from it)
